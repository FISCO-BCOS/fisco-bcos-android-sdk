...
public enum EnumNodeVersion {
    ...
    public static Version getClassVersion(String version) throws ClientException {
        try {
            ...
            if (s1.length >= 3) {
                ...
                throw new ClientException(" invalid node version format, version: " + version);
            }
    ...
    public static boolean channelProtocolHandleShakeSupport(String version) throws ClientException {
