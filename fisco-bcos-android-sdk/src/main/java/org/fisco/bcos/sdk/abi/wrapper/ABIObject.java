    ...
    public String toString() {
        ...
        if (type == ObjectType.VALUE) {
            ...
            switch (valueType) {
                case BOOL:
                    str += ", booValueType=";
                    str += (boolValue == null) ? "null" : boolValue.getValue();
                    break;
                case UINT:
                case INT:
                    str += ", numericValue=";
                    str += (numericValue == null) ? "null" : numericValue.getValue();
                    break;
                case ADDRESS:
                    str += ", addressValue=";
                    str += (addressValue == null) ? "null" : addressValue.getValue();
                    break;
                case BYTES:
                    str += ", bytesValue=";
                    str += (bytesValue == null) ? "null" : bytesValue.getValue();
                    break;
                case DBYTES:
                ...
                default:
                    str += ", stringValue=";
                    str += (stringValue == null) ? "null" : stringValue.getValue();
            }
