...
public class ABIObjectCodecTest {
    ...
    public void testBytesEncode() throws Exception {
        ...
        ContractABIDefinition contractABIDefinition = Utils.getContractABIDefinition(proxyDesc);
        ...
        byte[] encode = Base64.encode(bytesValue.getBytes(), android.util.Base64.NO_WRAP);
