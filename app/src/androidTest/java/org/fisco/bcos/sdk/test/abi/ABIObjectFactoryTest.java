...
public class ABIObjectFactoryTest {
    ...
    public void buildRawTypeObjectTest() {
        Assert.assertTrue(
                ABIObjectFactory.buildRawTypeObject("uint").getValueType()
                        == ABIObject.ValueType.UINT);
        Assert.assertTrue(
                ABIObjectFactory.buildRawTypeObject("uint256").getValueType()
                        == ABIObject.ValueType.UINT);
        Assert.assertTrue(
                ABIObjectFactory.buildRawTypeObject("int").getValueType()
                        == ABIObject.ValueType.INT);
        Assert.assertTrue(
                ABIObjectFactory.buildRawTypeObject("int256").getValueType()
                        == ABIObject.ValueType.INT);
        Assert.assertTrue(
                ABIObjectFactory.buildRawTypeObject("bool").getValueType()
                        == ABIObject.ValueType.BOOL);
        Assert.assertTrue(
                ABIObjectFactory.buildRawTypeObject("address").getValueType()
                        == ABIObject.ValueType.ADDRESS);
        Assert.assertTrue(
                ABIObjectFactory.buildRawTypeObject("bytes").getValueType()
                        == ABIObject.ValueType.DBYTES);
        Assert.assertTrue(
                ABIObjectFactory.buildRawTypeObject("bytes1").getValueType()
                        == ABIObject.ValueType.BYTES);
        Assert.assertTrue(
                ABIObjectFactory.buildRawTypeObject("bytes32").getValueType()
                        == ABIObject.ValueType.BYTES);
        Assert.assertTrue(
                ABIObjectFactory.buildRawTypeObject("string").getValueType()
    ...
    public void testContractABIDefinitionDynamic() throws Exception {
        ...
        */
        ...
        ABIObject inputObject3 =
                ABIObjectFactory.createInputObject(
                        contractABIDefinition.getFunctions().get("d").get(0));
        assertTrue(!inputObject3.getStructFields().get(0).isDynamic());

        ABIObject inputObject4 =
                ABIObjectFactory.createInputObject(
                        contractABIDefinition.getFunctions().get("e").get(0));
        ...
        ABIObject inputObject5 =
                ABIObjectFactory.createInputObject(
                        contractABIDefinition.getFunctions().get("f").get(0));
        ...
        ABIObject inputObject6 =
                ABIObjectFactory.createInputObject(
                        contractABIDefinition.getFunctions().get("g").get(0));
        ...
        ABIObject inputObject7 =
                ABIObjectFactory.createInputObject(
                        contractABIDefinition.getFunctions().get("h").get(0));
    ...
    public void testContractABIDefinitionDynamic2() throws Exception {
        ...
        */
        ...
        assertTrue(!inputObject1.getStructFields().get(2).isDynamic());
        assertTrue(!inputObject1.getStructFields().get(3).isDynamic());
        assertTrue(!inputObject1.getStructFields().get(4).isDynamic());
        ...
        assertTrue(!inputObject2.getStructFields().get(0).isDynamic());
        assertTrue(!inputObject2.getStructFields().get(1).isDynamic());
        assertTrue(!inputObject2.getStructFields().get(2).isDynamic());
        assertTrue(!inputObject2.getStructFields().get(3).isDynamic());
        assertTrue(!inputObject2.getStructFields().get(4).isDynamic());
